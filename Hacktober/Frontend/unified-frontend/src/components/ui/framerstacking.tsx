...
// Local stub for ReactLenis when '@studio-freight/lenis' is not installed.
// This stub renders children directly and preserves a minimal prop shape used in this file.
const ReactLenis: FC<{ root?: boolean; children?: ReactNode }> = ({ children }) => <>{children}</>;
import { useTransform, motion, useScroll, MotionValue } from 'motion/react';
import { useRef } from 'react';
const Image: FC<{ fill?: boolean; src: string; alt?: string; className?: string }> = ({
    fill,
    src,
    alt,
    className,
}) => {
    // mimic Next.js Image 'fill' behaviour with an absolutely positioned img
    return (
        <img
            src={src}
            alt={alt}
